...
char sQuery_CreateTable_Users_Loadouts[] = "CREATE TABLE IF NOT EXISTS `%s_users_loadouts` ( `id` int(11) NOT NULL AUTO_INCREMENT, `user_id` int(11) NOT NULL, `loadout_id` int(11) NOT NULL, PRIMARY KEY  (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci;";
char sQuery_CreateTable_Versions[] = "CREATE TABLE IF NOT EXISTS `%s_versions` ( `id` INT(11) NOT NULL AUTO_INCREMENT, `mod_name` VARCHAR(64) NOT NULL, `mod_description` VARCHAR(64) NULL DEFAULT NULL, `mod_ver_convar` VARCHAR(64) NULL DEFAULT NULL, `mod_ver_number` VARCHAR(64) NOT NULL, `server_id` VARCHAR(64) NOT NULL, `created_at` bigint(12) default 0, `last_updated` bigint(12) default 0, PRIMARY KEY (`id`), UNIQUE INDEX `UNIQUE PLUGIN ON SERVER` (`mod_ver_convar`, `server_id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci;";
...
public void SQLCall_ConnectToDatabase(Handle owner, Handle hndl, const char[] error, any data)
{
    ...
    Format(sQuery, sizeof(sQuery), sQuery_CreateTable_Users_Loadouts, STORE_DATABASE_PREFIX);
	SQL_AddQuery(trans, sQuery);
